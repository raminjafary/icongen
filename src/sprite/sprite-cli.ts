...
Examples:
  ...
  icongen-icons-sprite --all --verbose

  # Generate specific configuration by name
  icongen-icons-sprite --name icons-sprite --verbose

  # Generate with multiple source/output pairs
  icongen-icons-sprite --src ./examples/svg --dist ./dist/sprite --src ./examples/svg --dist ./dist

  # List available configurations
  icongen-icons-sprite --list

  # Use custom config file
  icongen-icons-sprite --config ./my-config.json --all

  # Generate sprite with specific SVGO config
  icongen-icons-sprite --svgo-config web --verbose
