...
Examples:
  @raminjafary/icongen --src ./my-icons
  @raminjafary/icongen --src ./icons --verbose --website
  @raminjafary/icongen --src ./icons --dist ./fonts --font-name my-icons
  @raminjafary/icongen --src ./icons --css-prefix icon --optimize --website
  @raminjafary/icongen --src ./icons --optimize --fix-strokes --verbose
  @raminjafary/icongen --src ./icons --no-hash-revving  # Disable hash revving
  @raminjafary/icongen --src ./icons --hash-revving     # Explicitly enable hash revving
...
async function main(): Promise<void> {
  ...
  if (!options.src) {
    ...
    console.error('   Example: @raminjafary/icongen --src ./my-icons --dist ./fonts');
    process.exit(1);
  }
